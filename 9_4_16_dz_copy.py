...
"""Генерируем рандомное число для локатора, чтобы проверять любой товар"""
product_locator_example = driver.find_element(By.XPATH, "//a[@id='item_0_title_link']")
product_locator_list = "//a[@id='item_0_title_link']".split('_')
product_digit = product_locator_list[1]
print(product_digit)
random_digit = str(random.randint(0, 6))
new_product_locator = ''.join(product_locator_list[0] + '_' + random_digit + '_' + product_locator_list[2] + '_' +
                              product_locator_list[3])
print(new_product_locator)

"""INFO Product 1"""
product_1 = driver.find_element(By.XPATH, new_product_locator)
